...
const Weapons = [
    createWeapon('Pistol', 25, 'player-pistol', (scene: Phaser.Scene, player: any) => {
    ...
    createWeapon('Sword', 40, 'player-sword', (scene: Phaser.Scene, player: any) => {
    ...
    createWeapon('Rifle', 70, 'player-rifle', (scene: Phaser.Scene, player: any) => {
    ...
    createWeapon('Cannon', 100, 'player-cannon', (scene: Phaser.Scene, player: any) => {
